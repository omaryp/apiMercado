...
public interface IDashBoardMapper {
	...
	List<Comerciante> top_10_puntuales(GeneralPageTable pagData) throws SQLException,SQLIntegrityConstraintViolationException;
	List<Comerciante> top_10_deudores(GeneralPageTable pagData) throws SQLException,SQLIntegrityConstraintViolationException;
